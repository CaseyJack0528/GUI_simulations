...
class circle:
    ...
    def update_position(self):
        position_array = [[self.x], [self.y], [self.z]]
...
def update_angles():
    ...
    t = time.time()-
    x_angle += x_rotation_speed*t
    y_angle += y_rotation_speed*t
    z_angle += z_rotation_speed*t
...
while running:
    ...
    pygame.draw.line(screen, (0, 0, 255), 
                     ...
                     (int((screen_width/2) + 500*joy.get_axis(0)), int((screen_height/2) + 500*joy.get_axis(1))),
                      5)
    ...
    #cube_center = [int((screen_width/2) + 500*joy.get_axis(0)), int((screen_height/2) + 500*joy.get_axis(1))]
    update_angles()
